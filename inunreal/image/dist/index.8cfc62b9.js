...
const html2canvas = require("5593ae5148b58d8e");
document.getElementById("generate").addEventListener("click", ()=>{
    html2canvas(document.getElementById("canvas"), {
        ...
        const filename = "denonken_poster_" + Date.now() + ".png";
...
document.getElementById("avatar1-input").addEventListener("change", function() {
    const files = this.files;
    if (files.length === 0) return;
    else {
        const image = document.getElementById("avatar1");
...
document.getElementById("size-input").addEventListener("change", function() {
    name.style.fontSize = `${this.value}px`;
    name.style.lineHeight = `${this.value}px`;
});
document.getElementById("weight-input").addEventListener("change", function() {
    name.style.fontWeight = this.value;
});

},{"5593ae5148b58d8e":"j1W5C"}],"j1W5C":[function(require,module,exports) {
/*!
